...
<div class="row">
    ...
    if( $sesiones_programadas_distancia_disponibles != 0)
    {
        ...
        $fecha_inicio = strtotime($sesion['a_registro']);
            ...
            <div class="row" style="margin:5px;">
                <div class="panel">
                    <div class="breadcrumbs6 panel-heading" style="padding-left:20px;"><h1 id="titulo_registro">
                        ...
                        <div class="panel-body">
                        <?php
                        if ($fecha_termino >= strtotime($dia_actual) && $fecha_inicio <= strtotime($dia_actual)) {
                            ...
                            echo "El registro a la sesión no disponible.";
                        }
                        ?>
                    </div>
                </div>
