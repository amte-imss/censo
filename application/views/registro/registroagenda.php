...
<div class="panel">
    ...
    <div class="breadcrumbs6 panel-heading" style="padding-left:10px; padding-top: 10px; padding-bottom: 10px;">
        <h1><small><span class="glyphicon glyphicon-info-sign"></span></small> Bienvenido</h1>
    </div>
    <div class="panel-body">
        <div class="col-sm-12 col-md-12 col-lg-12">
            <div class="row" style="margin:5px;">
                ...
                <div class="panel">
                    <div class="breadcrumbs6 panel-heading" style="padding-left:10px; padding-top: 10px; padding-bottom: 10px;">
                        <h1><small><span class="glyphicon glyphicon-info-sign"></span></small> Talleres Presenciales</h1>
                    </div>
                    <div class="panel-body">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <a href="<?php echo site_url('registro'); ?>" value="Enviar notificación"  class="btn btn-primary  btn">Inscripción</a> 
                            ...
                            <div class="col-sm-12">
                                <div claa="table-responsive">
                                    <table class="table table-striped" style="background-color: #AAA">
                                        ...
                                        <td>
                                        <a href=' . site_url('registro/registrodistancia/' . $sesion['agenda_id']) . ' value="Enviar notificación"  class="btn btn-primary  btn">Inscripción</a>                                         
